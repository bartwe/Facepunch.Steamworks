...
public struct PartyBeacon {
    ...
    public SteamId Owner {
        get {
            ...
            _ = Internal.GetBeaconDetails(Id, ref owner, ref location, out _);
            return owner;
        }
    }
    ...
    ///     ReservationNotification callback.
    ...
    ///     Note: The user may already be in-flight to your game, so it's possible they will still connect and try to join your
    ///     party.
    /// </summary>
