...
namespace Steamworks.Data
{
	...
	{
		[FieldOffset( 0 )] public uint Ip4Address; // Host Order

		[FieldOffset( 16 )] internal SteamIPType Type; // m_eType ESteamIPType
		...
		public static implicit operator System.Net.IPAddress( SteamIPAddress value )
		{
			...
			throw new System.Exception(
				$"Oops - can't convert SteamIPAddress to System.Net.IPAddress because no-one coded support for {value.Type} yet" );
		}
	}
}
