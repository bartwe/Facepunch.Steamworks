...
namespace Steamworks {
    ...
    public struct SteamServerInit {
        ...
        /// <summary>
        ///     The version string is usually in the form x.x.x.x, and is used by the master server to detect when the server is
        ///     out of date.
        ///     If you go into the dedicated server tab on steamworks you'll be able to server the latest version. If this version
        ///     number is
        ...
        /// <summary>
        ///     This should be the same directory game where gets installed into. Just the folder name, not the whole path. I.e.
        ///     "Rust", "Garrysmod".
        /// </summary>
        ...
        ///     "GameSocketShare" mode, which means that the game is responsible for sending and receiving UDP packets for the
        ///     master
        ///     server updater.
