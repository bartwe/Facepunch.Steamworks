...
namespace Steamworks {
    sealed class ISteamNetworking : SteamInterface {
    ...
    #region FunctionMeta
        ...
        static extern bool _SendP2PPacket(IntPtr self, SteamId steamIDRemote, IntPtr pubData, uint cubData, P2PSend eP2PSendType, int nChannel);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _IsP2PPacketAvailable(IntPtr self, ref uint pcubMsgSize, int nChannel);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _ReadP2PPacket(IntPtr self, IntPtr pubDest, uint cubDest, ref uint pcubMsgSize, ref SteamId psteamIDRemote, int nChannel);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _AcceptP2PSessionWithUser(IntPtr self, SteamId steamIDRemote);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _CloseP2PSessionWithUser(IntPtr self, SteamId steamIDRemote);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _CloseP2PChannelWithUser(IntPtr self, SteamId steamIDRemote, int nChannel);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _GetP2PSessionState(IntPtr self, SteamId steamIDRemote, ref P2PSessionState_t pConnectionState);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _AllowP2PPacketRelay(IntPtr self, [MarshalAs(UnmanagedType.U1)] bool bAllow);
    ...
    #region FunctionMeta
        ...
        static extern SNetSocket_t _CreateP2PConnectionSocket(IntPtr self, SteamId steamIDTarget, int nVirtualPort, int nTimeoutSec, [MarshalAs(UnmanagedType.U1)] bool bAllowUseOfPacketRelay);
