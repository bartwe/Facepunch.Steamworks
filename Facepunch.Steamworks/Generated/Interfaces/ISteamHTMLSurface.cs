...
namespace Steamworks {
    sealed class ISteamHTMLSurface : SteamInterface {
    ...
    #region FunctionMeta
        ...
        static extern bool _Init(IntPtr self);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _Shutdown(IntPtr self);
    ...
    #region FunctionMeta
        ...
        static extern SteamAPICall_t _CreateBrowser(
            IntPtr self, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchUserAgent,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchUserCSS
        );

    #endregion

        internal CallResult<HTML_BrowserReady_t> CreateBrowser(
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchUserAgent,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchUserCSS
        ) {
    ...
    #region FunctionMeta
        ...
        static extern void _RemoveBrowser(IntPtr self, HHTMLBrowser unBrowserHandle);
    ...
    #region FunctionMeta
        ...
        static extern void _LoadURL(
            IntPtr self, HHTMLBrowser unBrowserHandle, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchURL,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchPostData
        );

    #endregion

        internal void LoadURL(
            HHTMLBrowser unBrowserHandle, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchURL,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchPostData
        ) {
    ...
    #region FunctionMeta
        ...
        static extern void _SetSize(IntPtr self, HHTMLBrowser unBrowserHandle, uint unWidth, uint unHeight);
    ...
    #region FunctionMeta
        ...
        static extern void _StopLoad(IntPtr self, HHTMLBrowser unBrowserHandle);
    ...
    #region FunctionMeta
        ...
        static extern void _Reload(IntPtr self, HHTMLBrowser unBrowserHandle);
    ...
    #region FunctionMeta
        ...
        static extern void _GoBack(IntPtr self, HHTMLBrowser unBrowserHandle);
    ...
    #region FunctionMeta
        ...
        static extern void _GoForward(IntPtr self, HHTMLBrowser unBrowserHandle);
    ...
    #region FunctionMeta
        ...
        static extern void _AddHeader(
            IntPtr self, HHTMLBrowser unBrowserHandle, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchKey,
        ...
        internal void AddHeader(
            HHTMLBrowser unBrowserHandle, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchKey,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchValue
        ) {
    ...
    #region FunctionMeta
        ...
        static extern void _ExecuteJavascript(IntPtr self, HHTMLBrowser unBrowserHandle, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchScript);
    ...
    #region FunctionMeta
        ...
        static extern void _MouseUp(IntPtr self, HHTMLBrowser unBrowserHandle, IntPtr eMouseButton);
    ...
    #region FunctionMeta
        ...
        static extern void _MouseDown(IntPtr self, HHTMLBrowser unBrowserHandle, IntPtr eMouseButton);
    ...
    #region FunctionMeta
        ...
        static extern void _MouseDoubleClick(IntPtr self, HHTMLBrowser unBrowserHandle, IntPtr eMouseButton);
    ...
    #region FunctionMeta
        ...
        static extern void _MouseMove(IntPtr self, HHTMLBrowser unBrowserHandle, int x, int y);
    ...
    #region FunctionMeta
        ...
        static extern void _MouseWheel(IntPtr self, HHTMLBrowser unBrowserHandle, int nDelta);
    ...
    #region FunctionMeta
        ...
        static extern void _KeyDown(IntPtr self, HHTMLBrowser unBrowserHandle, uint nNativeKeyCode, IntPtr eHTMLKeyModifiers, [MarshalAs(UnmanagedType.U1)] bool bIsSystemKey);
    ...
    #region FunctionMeta
        ...
        static extern void _KeyUp(IntPtr self, HHTMLBrowser unBrowserHandle, uint nNativeKeyCode, IntPtr eHTMLKeyModifiers);
    ...
    #region FunctionMeta
        ...
        static extern void _KeyChar(IntPtr self, HHTMLBrowser unBrowserHandle, uint cUnicodeChar, IntPtr eHTMLKeyModifiers);
    ...
    #region FunctionMeta
        ...
        static extern void _SetHorizontalScroll(IntPtr self, HHTMLBrowser unBrowserHandle, uint nAbsolutePixelScroll);
    ...
    #region FunctionMeta
        ...
        static extern void _SetVerticalScroll(IntPtr self, HHTMLBrowser unBrowserHandle, uint nAbsolutePixelScroll);
    ...
    #region FunctionMeta
        ...
        static extern void _SetKeyFocus(IntPtr self, HHTMLBrowser unBrowserHandle, [MarshalAs(UnmanagedType.U1)] bool bHasKeyFocus);
    ...
    #region FunctionMeta
        ...
        static extern void _ViewSource(IntPtr self, HHTMLBrowser unBrowserHandle);
    ...
    #region FunctionMeta
        ...
        static extern void _CopyToClipboard(IntPtr self, HHTMLBrowser unBrowserHandle);
    ...
    #region FunctionMeta
        ...
        static extern void _PasteFromClipboard(IntPtr self, HHTMLBrowser unBrowserHandle);
    ...
    #region FunctionMeta
        ...
        static extern void _Find(
            IntPtr self, HHTMLBrowser unBrowserHandle, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchSearchStr,
            [MarshalAs(UnmanagedType.U1)] bool bCurrentlyInFind, [MarshalAs(UnmanagedType.U1)] bool bReverse
        );

    #endregion

        internal void Find(
            HHTMLBrowser unBrowserHandle, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchSearchStr,
            [MarshalAs(UnmanagedType.U1)] bool bCurrentlyInFind, [MarshalAs(UnmanagedType.U1)] bool bReverse
        ) {
    ...
    #region FunctionMeta
        ...
        static extern void _StopFind(IntPtr self, HHTMLBrowser unBrowserHandle);
    ...
    #region FunctionMeta
        ...
        static extern void _GetLinkAtPosition(IntPtr self, HHTMLBrowser unBrowserHandle, int x, int y);
    ...
    #region FunctionMeta
        ...
        static extern void _SetCookie(
            IntPtr self, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchHostname,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchKey,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchValue,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchPath, RTime32 nExpires, [MarshalAs(UnmanagedType.U1)] bool bSecure,
        ...
        internal void SetCookie(
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchHostname,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchKey,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchValue,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchPath, RTime32 nExpires, [MarshalAs(UnmanagedType.U1)] bool bSecure,
            [MarshalAs(UnmanagedType.U1)] bool bHTTPOnly
    ...
    #region FunctionMeta
        ...
        static extern void _SetPageScaleFactor(IntPtr self, HHTMLBrowser unBrowserHandle, float flZoom, int nPointX, int nPointY);
    ...
    #region FunctionMeta
        ...
        static extern void _SetBackgroundMode(IntPtr self, HHTMLBrowser unBrowserHandle, [MarshalAs(UnmanagedType.U1)] bool bBackgroundMode);
    ...
    #region FunctionMeta
        ...
        static extern void _SetDPIScalingFactor(IntPtr self, HHTMLBrowser unBrowserHandle, float flDPIScaling);
    ...
    #region FunctionMeta
        ...
        static extern void _OpenDeveloperTools(IntPtr self, HHTMLBrowser unBrowserHandle);
    ...
    #region FunctionMeta
        ...
        static extern void _AllowStartRequest(IntPtr self, HHTMLBrowser unBrowserHandle, [MarshalAs(UnmanagedType.U1)] bool bAllowed);
    ...
    #region FunctionMeta
        ...
        static extern void _JSDialogResponse(IntPtr self, HHTMLBrowser unBrowserHandle, [MarshalAs(UnmanagedType.U1)] bool bResult);
    ...
    #region FunctionMeta
        ...
        static extern void _FileLoadDialogResponse(
            IntPtr self, HHTMLBrowser unBrowserHandle, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchSelectedFiles
        );
