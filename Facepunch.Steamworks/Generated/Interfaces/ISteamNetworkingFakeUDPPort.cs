...
namespace Steamworks
{
	internal unsafe class ISteamNetworkingFakeUDPPort : SteamInterface
	{
		...
		[DllImport( Platform.LibraryName, EntryPoint = "SteamAPI_ISteamNetworkingFakeUDPPort_DestroyFakeUDPPort",
		...
		[DllImport( Platform.LibraryName, EntryPoint = "SteamAPI_ISteamNetworkingFakeUDPPort_SendMessageToFakeIP",
			CallingConvention = Platform.CC )]
		private static extern Result _SendMessageToFakeIP( IntPtr self, ref NetAddress remoteAddress, IntPtr pData,
			uint cbData, int nSendFlags );
		...
		[DllImport( Platform.LibraryName, EntryPoint = "SteamAPI_ISteamNetworkingFakeUDPPort_ReceiveMessages",
			CallingConvention = Platform.CC )]
		...
		[DllImport( Platform.LibraryName, EntryPoint = "SteamAPI_ISteamNetworkingFakeUDPPort_ScheduleCleanup",
			CallingConvention = Platform.CC )]
