...
namespace Steamworks {
    sealed class ISteamApps : SteamInterface {
    ...
    #region FunctionMeta
        ...
        static extern bool _BIsSubscribed(IntPtr self);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _BIsLowViolence(IntPtr self);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _BIsCybercafe(IntPtr self);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _BIsVACBanned(IntPtr self);
    ...
    #region FunctionMeta
        ...
        static extern Utf8StringPointer _GetCurrentGameLanguage(IntPtr self);
    ...
    #region FunctionMeta
        ...
        static extern Utf8StringPointer _GetAvailableGameLanguages(IntPtr self);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _BIsSubscribedApp(IntPtr self, AppId appID);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _BIsDlcInstalled(IntPtr self, AppId appID);
    ...
    #region FunctionMeta
        ...
        static extern uint _GetEarliestPurchaseUnixTime(IntPtr self, AppId nAppID);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _BIsSubscribedFromFreeWeekend(IntPtr self);
    ...
    #region FunctionMeta
        ...
        static extern int _GetDLCCount(IntPtr self);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _BGetDLCDataByIndex(IntPtr self, int iDLC, ref AppId pAppID, [MarshalAs(UnmanagedType.U1)] ref bool pbAvailable, IntPtr pchName, int cchNameBufferSize);
    ...
    #region FunctionMeta
        ...
        static extern void _InstallDLC(IntPtr self, AppId nAppID);
    ...
    #region FunctionMeta
        ...
        static extern void _UninstallDLC(IntPtr self, AppId nAppID);
    ...
    #region FunctionMeta
        ...
        static extern void _RequestAppProofOfPurchaseKey(IntPtr self, AppId nAppID);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _GetCurrentBetaName(IntPtr self, IntPtr pchName, int cchNameBufferSize);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _MarkContentCorrupt(IntPtr self, [MarshalAs(UnmanagedType.U1)] bool bMissingFilesOnly);
    ...
    #region FunctionMeta
        ...
        static extern uint _GetInstalledDepots(IntPtr self, AppId appID, [In] [Out] DepotId_t[] pvecDepots, uint cMaxDepots);
    ...
    #region FunctionMeta
        ...
        static extern uint _GetAppInstallDir(IntPtr self, AppId appID, IntPtr pchFolder, uint cchFolderBufferSize);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _BIsAppInstalled(IntPtr self, AppId appID);
    ...
    #region FunctionMeta
        ...
        static extern SteamId _GetAppOwner(IntPtr self);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _GetDlcDownloadProgress(IntPtr self, AppId nAppID, ref ulong punBytesDownloaded, ref ulong punBytesTotal);
    ...
    #region FunctionMeta
        ...
        static extern int _GetAppBuildId(IntPtr self);
    ...
    #region FunctionMeta
        ...
        static extern void _RequestAllProofOfPurchaseKeys(IntPtr self);
    ...
    #region FunctionMeta
        ...
        static extern int _GetLaunchCommandLine(IntPtr self, IntPtr pszCommandLine, int cubCommandLine);

    #endregion

        internal int GetLaunchCommandLine(out string pszCommandLine) {
            var mempszCommandLine = Helpers.TakeMemory();
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _BIsSubscribedFromFamilySharing(IntPtr self);
    ...
    #region FunctionMeta
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        static extern bool _BIsTimedTrial(IntPtr self, ref uint punSecondsAllowed, ref uint punSecondsPlayed);
