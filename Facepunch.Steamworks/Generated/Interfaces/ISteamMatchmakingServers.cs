...
namespace Steamworks {
    sealed class ISteamMatchmakingServers : SteamInterface {
    ...
    #region FunctionMeta
        ...
        static extern HServerListRequest _RequestInternetServerList(IntPtr self, AppId iApp, [In] [Out] ref MatchMakingKeyValuePair[] ppchFilters, uint nFilters, IntPtr pRequestServersResponse);
    ...
    #region FunctionMeta
        ...
        static extern HServerListRequest _RequestLANServerList(IntPtr self, AppId iApp, IntPtr pRequestServersResponse);
    ...
    #region FunctionMeta
        ...
        static extern HServerListRequest _RequestFriendsServerList(IntPtr self, AppId iApp, [In] [Out] ref MatchMakingKeyValuePair[] ppchFilters, uint nFilters, IntPtr pRequestServersResponse);
    ...
    #region FunctionMeta
        ...
        static extern HServerListRequest _RequestFavoritesServerList(IntPtr self, AppId iApp, [In] [Out] ref MatchMakingKeyValuePair[] ppchFilters, uint nFilters, IntPtr pRequestServersResponse);
    ...
    #region FunctionMeta
        ...
        static extern HServerListRequest _RequestHistoryServerList(IntPtr self, AppId iApp, [In] [Out] ref MatchMakingKeyValuePair[] ppchFilters, uint nFilters, IntPtr pRequestServersResponse);
    ...
    #region FunctionMeta
        ...
        static extern HServerListRequest _RequestSpectatorServerList(IntPtr self, AppId iApp, [In] [Out] ref MatchMakingKeyValuePair[] ppchFilters, uint nFilters, IntPtr pRequestServersResponse);
    ...
    #region FunctionMeta
        ...
        static extern void _ReleaseRequest(IntPtr self, HServerListRequest hServerListRequest);
    ...
    #region FunctionMeta
        ...
        static extern IntPtr _GetServerDetails(IntPtr self, HServerListRequest hRequest, int iServer);
    ...
    #region FunctionMeta
        ...
        static extern void _CancelQuery(IntPtr self, HServerListRequest hRequest);
    ...
    #region FunctionMeta
        ...
        static extern void _RefreshQuery(IntPtr self, HServerListRequest hRequest);
    ...
    #region FunctionMeta
        ...
        static extern bool _IsRefreshing(IntPtr self, HServerListRequest hRequest);
    ...
    #region FunctionMeta
        ...
        static extern int _GetServerCount(IntPtr self, HServerListRequest hRequest);
    ...
    #region FunctionMeta
        ...
        static extern void _RefreshServer(IntPtr self, HServerListRequest hRequest, int iServer);
    ...
    #region FunctionMeta
        ...
        static extern HServerQuery _PingServer(IntPtr self, uint unIP, ushort usPort, IntPtr pRequestServersResponse);
    ...
    #region FunctionMeta
        ...
        static extern HServerQuery _PlayerDetails(IntPtr self, uint unIP, ushort usPort, IntPtr pRequestServersResponse);
    ...
    #region FunctionMeta
        ...
        static extern HServerQuery _ServerRules(IntPtr self, uint unIP, ushort usPort, IntPtr pRequestServersResponse);
    ...
    #region FunctionMeta
        ...
        static extern void _CancelServerQuery(IntPtr self, HServerQuery hServerQuery);
