...
sealed class ISteamFriends : SteamInterface {
...
#region FunctionMeta
    ...
    static extern Utf8StringPointer _GetPersonaName(IntPtr self);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _SetPersonaName(IntPtr self, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchPersonaName);
...
#region FunctionMeta
    ...
    static extern FriendState _GetPersonaState(IntPtr self);
...
#region FunctionMeta
    ...
    static extern int _GetFriendCount(IntPtr self, int iFriendFlags);
...
#region FunctionMeta
    ...
    static extern SteamId _GetFriendByIndex(IntPtr self, int iFriend, int iFriendFlags);
...
#region FunctionMeta
    ...
    static extern Relationship _GetFriendRelationship(IntPtr self, SteamId steamIDFriend);
...
#region FunctionMeta
    ...
    static extern FriendState _GetFriendPersonaState(IntPtr self, SteamId steamIDFriend);
...
#region FunctionMeta
    ...
    static extern Utf8StringPointer _GetFriendPersonaName(IntPtr self, SteamId steamIDFriend);
...
#region FunctionMeta
    ...
    static extern bool _GetFriendGamePlayed(IntPtr self, SteamId steamIDFriend, ref FriendGameInfo_t pFriendGameInfo);
...
#region FunctionMeta
    ...
    static extern Utf8StringPointer _GetFriendPersonaNameHistory(IntPtr self, SteamId steamIDFriend, int iPersonaName);
...
#region FunctionMeta
    ...
    static extern int _GetFriendSteamLevel(IntPtr self, SteamId steamIDFriend);
...
#region FunctionMeta
    ...
    static extern Utf8StringPointer _GetPlayerNickname(IntPtr self, SteamId steamIDPlayer);
...
#region FunctionMeta
    ...
    static extern int _GetFriendsGroupCount(IntPtr self);
...
#region FunctionMeta
    ...
    static extern FriendsGroupID_t _GetFriendsGroupIDByIndex(IntPtr self, int iFG);
...
#region FunctionMeta
    ...
    static extern Utf8StringPointer _GetFriendsGroupName(IntPtr self, FriendsGroupID_t friendsGroupID);
...
#region FunctionMeta
    ...
    static extern int _GetFriendsGroupMembersCount(IntPtr self, FriendsGroupID_t friendsGroupID);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _HasFriend(IntPtr self, SteamId steamIDFriend, int iFriendFlags);
...
#region FunctionMeta
    ...
    static extern int _GetClanCount(IntPtr self);
...
#region FunctionMeta
    ...
    static extern SteamId _GetClanByIndex(IntPtr self, int iClan);
...
#region FunctionMeta
    ...
    static extern Utf8StringPointer _GetClanName(IntPtr self, SteamId steamIDClan);
...
#region FunctionMeta
    ...
    static extern Utf8StringPointer _GetClanTag(IntPtr self, SteamId steamIDClan);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetClanActivityCounts(IntPtr self, SteamId steamIDClan, ref int pnOnline, ref int pnInGame, ref int pnChatting);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _DownloadClanActivityCounts(IntPtr self, [In] [Out] SteamId[] psteamIDClans, int cClansToRequest);
...
#region FunctionMeta
    ...
    static extern int _GetFriendCountFromSource(IntPtr self, SteamId steamIDSource);
...
#region FunctionMeta
    ...
    static extern SteamId _GetFriendFromSourceByIndex(IntPtr self, SteamId steamIDSource, int iFriend);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _IsUserInSource(IntPtr self, SteamId steamIDUser, SteamId steamIDSource);
...
#region FunctionMeta
    ...
    static extern void _SetInGameVoiceSpeaking(IntPtr self, SteamId steamIDUser, [MarshalAs(UnmanagedType.U1)] bool bSpeaking);
...
#region FunctionMeta
    ...
    static extern void _ActivateGameOverlay(IntPtr self, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchDialog);
...
#region FunctionMeta
    ...
    static extern void _ActivateGameOverlayToUser(IntPtr self, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchDialog, SteamId steamID);
...
#region FunctionMeta
    ...
    static extern void _ActivateGameOverlayToWebPage(
        IntPtr self, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchURL, ActivateGameOverlayToWebPageMode eMode
    );
...
#region FunctionMeta
    ...
    static extern void _ActivateGameOverlayToStore(IntPtr self, AppId nAppID, OverlayToStoreFlag eFlag);
...
#region FunctionMeta
    ...
    static extern void _SetPlayedWith(IntPtr self, SteamId steamIDUserPlayedWith);
...
#region FunctionMeta
    ...
    static extern void _ActivateGameOverlayInviteDialog(IntPtr self, SteamId steamIDLobby);
...
#region FunctionMeta
    ...
    static extern int _GetSmallFriendAvatar(IntPtr self, SteamId steamIDFriend);
...
#region FunctionMeta
    ...
    static extern int _GetMediumFriendAvatar(IntPtr self, SteamId steamIDFriend);
...
#region FunctionMeta
    ...
    static extern int _GetLargeFriendAvatar(IntPtr self, SteamId steamIDFriend);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _RequestUserInformation(IntPtr self, SteamId steamIDUser, [MarshalAs(UnmanagedType.U1)] bool bRequireNameOnly);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _RequestClanOfficerList(IntPtr self, SteamId steamIDClan);
...
#region FunctionMeta
    ...
    static extern SteamId _GetClanOwner(IntPtr self, SteamId steamIDClan);
...
#region FunctionMeta
    ...
    static extern int _GetClanOfficerCount(IntPtr self, SteamId steamIDClan);
...
#region FunctionMeta
    ...
    static extern SteamId _GetClanOfficerByIndex(IntPtr self, SteamId steamIDClan, int iOfficer);
...
#region FunctionMeta
    ...
    static extern uint _GetUserRestrictions(IntPtr self);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetRichPresence(
        IntPtr self, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchKey,
...
#region FunctionMeta
    ...
    static extern void _ClearRichPresence(IntPtr self);
...
#region FunctionMeta
    ...
    static extern Utf8StringPointer _GetFriendRichPresence(IntPtr self, SteamId steamIDFriend, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchKey);
...
#region FunctionMeta
    ...
    static extern int _GetFriendRichPresenceKeyCount(IntPtr self, SteamId steamIDFriend);
...
#region FunctionMeta
    ...
    static extern void _RequestFriendRichPresence(IntPtr self, SteamId steamIDFriend);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _InviteUserToGame(IntPtr self, SteamId steamIDFriend, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchConnectString);
...
#region FunctionMeta
    ...
    static extern int _GetCoplayFriendCount(IntPtr self);
...
#region FunctionMeta
    ...
    static extern SteamId _GetCoplayFriend(IntPtr self, int iCoplayFriend);
...
#region FunctionMeta
    ...
    static extern int _GetFriendCoplayTime(IntPtr self, SteamId steamIDFriend);
...
#region FunctionMeta
    ...
    static extern AppId _GetFriendCoplayGame(IntPtr self, SteamId steamIDFriend);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _JoinClanChatRoom(IntPtr self, SteamId steamIDClan);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _LeaveClanChatRoom(IntPtr self, SteamId steamIDClan);
...
#region FunctionMeta
    ...
    static extern int _GetClanChatMemberCount(IntPtr self, SteamId steamIDClan);
...
#region FunctionMeta
    ...
    static extern SteamId _GetChatMemberByIndex(IntPtr self, SteamId steamIDClan, int iUser);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SendClanChatMessage(IntPtr self, SteamId steamIDClanChat, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchText);
...
#region FunctionMeta
    ...
    static extern int _GetClanChatMessage(IntPtr self, SteamId steamIDClanChat, int iMessage, IntPtr prgchText, int cchTextMax, ref ChatEntryType peChatEntryType, ref SteamId psteamidChatter);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _IsClanChatAdmin(IntPtr self, SteamId steamIDClanChat, SteamId steamIDUser);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _IsClanChatWindowOpenInSteam(IntPtr self, SteamId steamIDClanChat);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _OpenClanChatWindowInSteam(IntPtr self, SteamId steamIDClanChat);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _CloseClanChatWindowInSteam(IntPtr self, SteamId steamIDClanChat);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetListenForFriendsMessages(IntPtr self, [MarshalAs(UnmanagedType.U1)] bool bInterceptEnabled);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _ReplyToFriendMessage(IntPtr self, SteamId steamIDFriend, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchMsgToSend);
...
#region FunctionMeta
    ...
    static extern int _GetFriendMessage(IntPtr self, SteamId steamIDFriend, int iMessageID, IntPtr pvData, int cubData, ref ChatEntryType peChatEntryType);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _GetFollowerCount(IntPtr self, SteamId steamID);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _IsFollowing(IntPtr self, SteamId steamID);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _EnumerateFollowingList(IntPtr self, uint unStartIndex);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _IsClanPublic(IntPtr self, SteamId steamIDClan);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _IsClanOfficialGameGroup(IntPtr self, SteamId steamIDClan);
...
#region FunctionMeta
    ...
    static extern int _GetNumChatsWithUnreadPriorityMessages(IntPtr self);
...
#region FunctionMeta
    ...
    static extern void _ActivateGameOverlayRemotePlayTogetherInviteDialog(IntPtr self, SteamId steamIDLobby);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _RegisterProtocolInOverlayBrowser(IntPtr self, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchProtocol);
...
#region FunctionMeta
    ...
    static extern void _ActivateGameOverlayInviteDialogConnectString(IntPtr self, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchConnectString);
