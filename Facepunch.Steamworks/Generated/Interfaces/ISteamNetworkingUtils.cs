...
sealed unsafe class ISteamNetworkingUtils : SteamInterface {
...
#region FunctionMeta
    ...
    static extern NetMsg* _AllocateMessage(IntPtr self, int cbAllocateBuffer);
...
#region FunctionMeta
    ...
    static extern void _InitRelayNetworkAccess(IntPtr self);
...
#region FunctionMeta
    ...
    static extern SteamNetworkingAvailability _GetRelayNetworkStatus(IntPtr self, ref SteamRelayNetworkStatus_t pDetails);
...
#region FunctionMeta
    ...
    static extern float _GetLocalPingLocation(IntPtr self, ref NetPingLocation result);
...
#region FunctionMeta
    ...
    static extern int _EstimatePingTimeBetweenTwoLocations(IntPtr self, ref NetPingLocation location1, ref NetPingLocation location2);
...
#region FunctionMeta
    ...
    static extern int _EstimatePingTimeFromLocalHost(IntPtr self, ref NetPingLocation remoteLocation);
...
#region FunctionMeta
    ...
    static extern void _ConvertPingLocationToString(IntPtr self, ref NetPingLocation location, IntPtr pszBuf, int cchBufSize);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _CheckPingDataUpToDate(IntPtr self, float flMaxAgeSeconds);
...
#region FunctionMeta
    ...
    static extern int _GetPingToDataCenter(IntPtr self, SteamNetworkingPOPID popID, ref SteamNetworkingPOPID pViaRelayPoP);
...
#region FunctionMeta
    ...
    static extern int _GetDirectPingToPOP(IntPtr self, SteamNetworkingPOPID popID);
...
#region FunctionMeta
    ...
    static extern int _GetPOPCount(IntPtr self);
...
#region FunctionMeta
    ...
    static extern int _GetPOPList(IntPtr self, ref SteamNetworkingPOPID list, int nListSz);
...
#region FunctionMeta
    ...
    static extern long _GetLocalTimestamp(IntPtr self);
...
#region FunctionMeta
    ...
    static extern void _SetDebugOutputFunction(IntPtr self, NetDebugOutput eDetailLevel, NetDebugFunc pfnFunc);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetGlobalConfigValueInt32(IntPtr self, NetConfig eValue, int val);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetGlobalConfigValueFloat(IntPtr self, NetConfig eValue, float val);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetGlobalConfigValuePtr(IntPtr self, NetConfig eValue, IntPtr val);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetConnectionConfigValueInt32(IntPtr self, Connection hConn, NetConfig eValue, int val);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetConnectionConfigValueFloat(IntPtr self, Connection hConn, NetConfig eValue, float val);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetGlobalCallback_SteamNetConnectionStatusChanged(IntPtr self, FnSteamNetConnectionStatusChanged fnCallback);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetGlobalCallback_SteamNetAuthenticationStatusChanged(IntPtr self, FnSteamNetAuthenticationStatusChanged fnCallback);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetGlobalCallback_SteamRelayNetworkStatusChanged(IntPtr self, FnSteamRelayNetworkStatusChanged fnCallback);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetGlobalCallback_MessagesSessionRequest(IntPtr self, FnSteamNetworkingMessagesSessionRequest fnCallback);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetGlobalCallback_MessagesSessionFailed(IntPtr self, FnSteamNetworkingMessagesSessionFailed fnCallback);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetConfigValue(IntPtr self, NetConfig eValue, NetConfigScope eScopeType, IntPtr scopeObj, NetConfigType eDataType, IntPtr pArg);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetConfigValueStruct(IntPtr self, ref NetKeyValue opt, NetConfigScope eScopeType, IntPtr scopeObj);
...
#region FunctionMeta
    ...
    static extern NetConfigResult _GetConfigValue(IntPtr self, NetConfig eValue, NetConfigScope eScopeType, IntPtr scopeObj, ref NetConfigType pOutDataType, IntPtr pResult, ref UIntPtr cbResult);
...
#region FunctionMeta
    ...
    static extern NetConfig _GetFirstConfigValue(IntPtr self);
...
#region FunctionMeta
    ...
    static extern void _SteamNetworkingIPAddr_ToString(IntPtr self, ref NetAddress addr, IntPtr buf, uint cbBuf, [MarshalAs(UnmanagedType.U1)] bool bWithPort);
...
#region FunctionMeta
    ...
    static extern void _SteamNetworkingIdentity_ToString(IntPtr self, ref NetIdentity identity, IntPtr buf, uint cbBuf);
