...
sealed unsafe class ISteamNetworkingSockets : SteamInterface {
    ...
    static extern Socket _CreateListenSocketIP(IntPtr self, ref NetAddress localAddress, int nOptions, [In][Out] NetKeyValue[] pOptions);
    ...
    static extern Connection _ConnectByIPAddress(IntPtr self, ref NetAddress address, int nOptions, [In][Out] NetKeyValue[] pOptions);
    ...
    static extern Socket _CreateListenSocketP2P(IntPtr self, int nLocalVirtualPort, int nOptions, [In][Out] NetKeyValue[] pOptions);
    ...
    static extern Connection _ConnectP2P(IntPtr self, ref NetIdentity identityRemote, int nRemoteVirtualPort, int nOptions, [In][Out] NetKeyValue[] pOptions);
    ...
    static extern Result _AcceptConnection(IntPtr self, Connection hConn);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _CloseListenSocket(IntPtr self, Socket hSocket);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetConnectionUserData(IntPtr self, Connection hPeer, long nUserData);
    ...
    static extern long _GetConnectionUserData(IntPtr self, Connection hPeer);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetConnectionName(IntPtr self, Connection hPeer, IntPtr pszName, int nMaxLen);

    #endregion

    internal bool GetConnectionName(Connection hPeer, out string pszName) {
        var mempszName = Helpers.TakeMemory();
    ...
    static extern Result _SendMessageToConnection(IntPtr self, Connection hConn, IntPtr pData, uint cbData, int nSendFlags, ref long pOutMessageNumber);
    ...
    static extern void _SendMessages(IntPtr self, int nMessages, NetMsg** pMessages, long* pOutMessageNumberOrResult);
    ...
    static extern Result _FlushMessagesOnConnection(IntPtr self, Connection hConn);
    ...
    static extern int _ReceiveMessagesOnConnection(IntPtr self, Connection hConn, IntPtr ppOutMessages, int nMaxMessages);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetConnectionInfo(IntPtr self, Connection hConn, ref ConnectionInfo pInfo);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetQuickConnectionStatus(IntPtr self, Connection hConn, ref ConnectionStatus pStats);
    ...
    static extern int _GetDetailedConnectionStatus(IntPtr self, Connection hConn, IntPtr pszBuf, int cbBuf);

    #endregion

    internal int GetDetailedConnectionStatus(Connection hConn, out string pszBuf) {
        var mempszBuf = Helpers.TakeMemory();
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetListenSocketAddress(IntPtr self, Socket hSocket, ref NetAddress address);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _CreateSocketPair(
        IntPtr self, [In][Out] Connection[] pOutConnection1, [In][Out] Connection[] pOutConnection2, [MarshalAs(UnmanagedType.U1)] bool bUseNetworkLoopback, ref NetIdentity pIdentity1,
        ref NetIdentity pIdentity2
    );

    #endregion

    internal bool CreateSocketPair(
        [In][Out] Connection[] pOutConnection1, [In][Out] Connection[] pOutConnection2, [MarshalAs(UnmanagedType.U1)] bool bUseNetworkLoopback, ref NetIdentity pIdentity1,
        ref NetIdentity pIdentity2
    ) {
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetIdentity(IntPtr self, ref NetIdentity pIdentity);
    ...
    static extern SteamNetworkingAvailability _InitAuthentication(IntPtr self);
    ...
    static extern SteamNetworkingAvailability _GetAuthenticationStatus(IntPtr self, ref SteamNetAuthenticationStatus_t pDetails);
    ...
    static extern HSteamNetPollGroup _CreatePollGroup(IntPtr self);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _DestroyPollGroup(IntPtr self, HSteamNetPollGroup hPollGroup);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetConnectionPollGroup(IntPtr self, Connection hConn, HSteamNetPollGroup hPollGroup);
    ...
    static extern int _ReceiveMessagesOnPollGroup(IntPtr self, HSteamNetPollGroup hPollGroup, IntPtr ppOutMessages, int nMaxMessages);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _ReceivedRelayAuthTicket(IntPtr self, IntPtr pvTicket, int cbTicket, [In][Out] SteamDatagramRelayAuthTicket[] pOutParsedTicket);
    ...
    static extern int _FindRelayAuthTicketForServer(IntPtr self, ref NetIdentity identityGameServer, int nRemoteVirtualPort, [In][Out] SteamDatagramRelayAuthTicket[] pOutParsedTicket);
    ...
    static extern Connection _ConnectToHostedDedicatedServer(IntPtr self, ref NetIdentity identityTarget, int nRemoteVirtualPort, int nOptions, [In][Out] NetKeyValue[] pOptions);
    ...
    static extern ushort _GetHostedDedicatedServerPort(IntPtr self);
    ...
    static extern SteamNetworkingPOPID _GetHostedDedicatedServerPOPID(IntPtr self);
    ...
    static extern Result _GetHostedDedicatedServerAddress(IntPtr self, ref SteamDatagramHostedAddress pRouting);
    ...
    static extern Socket _CreateHostedDedicatedServerListenSocket(IntPtr self, int nLocalVirtualPort, int nOptions, [In][Out] NetKeyValue[] pOptions);
    ...
    static extern Result _GetGameCoordinatorServerLogin(IntPtr self, ref SteamDatagramGameCoordinatorServerLogin pLoginInfo, ref int pcbSignedBlob, IntPtr pBlob);
    ...
    static extern Connection _ConnectP2PCustomSignaling(IntPtr self, IntPtr pSignaling, ref NetIdentity pPeerIdentity, int nRemoteVirtualPort, int nOptions, [In][Out] NetKeyValue[] pOptions);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _ReceivedP2PCustomSignal(IntPtr self, IntPtr pMsg, int cbMsg, IntPtr pContext);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetCertificateRequest(IntPtr self, ref int pcbBlob, IntPtr pBlob, ref NetErrorMessage errMsg);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetCertificate(IntPtr self, IntPtr pCertificate, int cbCertificate, ref NetErrorMessage errMsg);
    ...
    static extern void _RunCallbacks(IntPtr self);
