...
namespace Steamworks {
    sealed class ISteamGameSearch : SteamInterface {
    ...
    #region FunctionMeta
        ...
        static extern GameSearchErrorCode_t _AddGameSearchParams(
            IntPtr self, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchKeyToFind,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchValuesToFind
        );

    #endregion

        internal GameSearchErrorCode_t AddGameSearchParams(
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchKeyToFind,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchValuesToFind
        ) {
    ...
    #region FunctionMeta
        ...
        static extern GameSearchErrorCode_t _SearchForGameWithLobby(IntPtr self, SteamId steamIDLobby, int nPlayerMin, int nPlayerMax);
    ...
    #region FunctionMeta
        ...
        static extern GameSearchErrorCode_t _SearchForGameSolo(IntPtr self, int nPlayerMin, int nPlayerMax);
    ...
    #region FunctionMeta
        ...
        static extern GameSearchErrorCode_t _AcceptGame(IntPtr self);
    ...
    #region FunctionMeta
        ...
        static extern GameSearchErrorCode_t _DeclineGame(IntPtr self);
    ...
    #region FunctionMeta
        ...
        static extern GameSearchErrorCode_t _RetrieveConnectionDetails(IntPtr self, SteamId steamIDHost, IntPtr pchConnectionDetails, int cubConnectionDetails);

    #endregion

        internal GameSearchErrorCode_t RetrieveConnectionDetails(SteamId steamIDHost, out string pchConnectionDetails) {
            var mempchConnectionDetails = Helpers.TakeMemory();
    ...
    #region FunctionMeta
        ...
        static extern GameSearchErrorCode_t _EndGameSearch(IntPtr self);
    ...
    #region FunctionMeta
        ...
        static extern GameSearchErrorCode_t _SetConnectionDetails(
            IntPtr self, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchConnectionDetails, int cubConnectionDetails
        );

    #endregion

        internal GameSearchErrorCode_t SetConnectionDetails(
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchConnectionDetails, int cubConnectionDetails
        ) {
    ...
    #region FunctionMeta
        ...
        static extern GameSearchErrorCode_t _RequestPlayersForGame(IntPtr self, int nPlayerMin, int nPlayerMax, int nMaxTeamSize);
    ...
    #region FunctionMeta
        ...
        static extern GameSearchErrorCode_t _HostConfirmGameStart(IntPtr self, ulong ullUniqueGameID);
    ...
    #region FunctionMeta
        ...
        static extern GameSearchErrorCode_t _CancelRequestPlayersForGame(IntPtr self);
    ...
    #region FunctionMeta
        ...
        static extern GameSearchErrorCode_t _SubmitPlayerResult(IntPtr self, ulong ullUniqueGameID, SteamId steamIDPlayer, PlayerResult_t EPlayerResult);
    ...
    #region FunctionMeta
        ...
        static extern GameSearchErrorCode_t _EndGame(IntPtr self, ulong ullUniqueGameID);
