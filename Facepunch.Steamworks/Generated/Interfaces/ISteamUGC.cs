...
sealed class ISteamUGC : SteamInterface {
...
#region FunctionMeta
    ...
    static extern UGCQueryHandle_t _CreateQueryUserUGCRequest(
    ...
    internal UGCQueryHandle_t CreateQueryUserUGCRequest(
        AccountID_t unAccountID, UserUGCList eListType, UgcType eMatchingUGCType, UserUGCListSortOrder eSortOrder, AppId nCreatorAppID, AppId nConsumerAppID, uint unPage
    ) {
...
#region FunctionMeta
    ...
    static extern UGCQueryHandle_t _CreateQueryAllUGCRequest(IntPtr self, UGCQuery eQueryType, UgcType eMatchingeMatchingUGCTypeFileType, AppId nCreatorAppID, AppId nConsumerAppID, uint unPage);
...
#region FunctionMeta
    ...
    static extern UGCQueryHandle_t _CreateQueryAllUGCRequest(
        IntPtr self, UGCQuery eQueryType, UgcType eMatchingeMatchingUGCTypeFileType, AppId nCreatorAppID, AppId nConsumerAppID,
    ...
    internal UGCQueryHandle_t CreateQueryAllUGCRequest(
        UGCQuery eQueryType, UgcType eMatchingeMatchingUGCTypeFileType, AppId nCreatorAppID, AppId nConsumerAppID,
        [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))]
        string pchCursor
    ) {
...
#region FunctionMeta
    ...
    static extern UGCQueryHandle_t _CreateQueryUGCDetailsRequest(IntPtr self, [In] [Out] PublishedFileId[] pvecPublishedFileID, uint unNumPublishedFileIDs);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _SendQueryUGCRequest(IntPtr self, UGCQueryHandle_t handle);
...
#region FunctionMeta
    ...
    static extern bool _GetQueryUGCResult(IntPtr self, UGCQueryHandle_t handle, uint index, ref SteamUGCDetails_t pDetails);
...
#region FunctionMeta
    ...
    static extern uint _GetQueryUGCNumTags(IntPtr self, UGCQueryHandle_t handle, uint index);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetQueryUGCTag(IntPtr self, UGCQueryHandle_t handle, uint index, uint indexTag, IntPtr pchValue, uint cchValueSize);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetQueryUGCTagDisplayName(IntPtr self, UGCQueryHandle_t handle, uint index, uint indexTag, IntPtr pchValue, uint cchValueSize);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetQueryUGCPreviewURL(IntPtr self, UGCQueryHandle_t handle, uint index, IntPtr pchURL, uint cchURLSize);

#endregion

    internal bool GetQueryUGCPreviewURL(UGCQueryHandle_t handle, uint index, out string pchURL) {
        var mempchURL = Helpers.TakeMemory();
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetQueryUGCMetadata(IntPtr self, UGCQueryHandle_t handle, uint index, IntPtr pchMetadata, uint cchMetadatasize);

#endregion

    internal bool GetQueryUGCMetadata(UGCQueryHandle_t handle, uint index, out string pchMetadata) {
        var mempchMetadata = Helpers.TakeMemory();
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetQueryUGCChildren(IntPtr self, UGCQueryHandle_t handle, uint index, [In] [Out] PublishedFileId[] pvecPublishedFileID, uint cMaxEntries);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetQueryUGCStatistic(IntPtr self, UGCQueryHandle_t handle, uint index, ItemStatistic eStatType, ref ulong pStatValue);
...
#region FunctionMeta
    ...
    static extern uint _GetQueryUGCNumAdditionalPreviews(IntPtr self, UGCQueryHandle_t handle, uint index);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetQueryUGCAdditionalPreview(
        IntPtr self, UGCQueryHandle_t handle, uint index, uint previewIndex, IntPtr pchURLOrVideoID, uint cchURLSize, IntPtr pchOriginalFileName, uint cchOriginalFileNameSize,
    ...
    internal bool GetQueryUGCAdditionalPreview(UGCQueryHandle_t handle, uint index, uint previewIndex, out string pchURLOrVideoID, out string pchOriginalFileName, ref ItemPreviewType pPreviewType) {
        ...
        var mempchOriginalFileName = Helpers.TakeMemory();
...
#region FunctionMeta
    ...
    static extern uint _GetQueryUGCNumKeyValueTags(IntPtr self, UGCQueryHandle_t handle, uint index);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetQueryUGCKeyValueTag(IntPtr self, UGCQueryHandle_t handle, uint index, uint keyValueTagIndex, IntPtr pchKey, uint cchKeySize, IntPtr pchValue, uint cchValueSize);
    ...
    internal bool GetQueryUGCKeyValueTag(UGCQueryHandle_t handle, uint index, uint keyValueTagIndex, out string pchKey, out string pchValue) {
        var mempchKey = Helpers.TakeMemory();
        var mempchValue = Helpers.TakeMemory();
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _ReleaseQueryUGCRequest(IntPtr self, UGCQueryHandle_t handle);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _AddRequiredTagGroup(IntPtr self, UGCQueryHandle_t handle, ref SteamParamStringArray_t pTagGroups);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetReturnOnlyIDs(IntPtr self, UGCQueryHandle_t handle, [MarshalAs(UnmanagedType.U1)] bool bReturnOnlyIDs);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetReturnKeyValueTags(IntPtr self, UGCQueryHandle_t handle, [MarshalAs(UnmanagedType.U1)] bool bReturnKeyValueTags);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetReturnLongDescription(IntPtr self, UGCQueryHandle_t handle, [MarshalAs(UnmanagedType.U1)] bool bReturnLongDescription);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetReturnMetadata(IntPtr self, UGCQueryHandle_t handle, [MarshalAs(UnmanagedType.U1)] bool bReturnMetadata);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetReturnChildren(IntPtr self, UGCQueryHandle_t handle, [MarshalAs(UnmanagedType.U1)] bool bReturnChildren);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetReturnAdditionalPreviews(IntPtr self, UGCQueryHandle_t handle, [MarshalAs(UnmanagedType.U1)] bool bReturnAdditionalPreviews);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetReturnTotalOnly(IntPtr self, UGCQueryHandle_t handle, [MarshalAs(UnmanagedType.U1)] bool bReturnTotalOnly);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetReturnPlaytimeStats(IntPtr self, UGCQueryHandle_t handle, uint unDays);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetAllowCachedResponse(IntPtr self, UGCQueryHandle_t handle, uint unMaxAgeSeconds);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetMatchAnyTag(IntPtr self, UGCQueryHandle_t handle, [MarshalAs(UnmanagedType.U1)] bool bMatchAnyTag);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetRankedByTrendDays(IntPtr self, UGCQueryHandle_t handle, uint unDays);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _CreateItem(IntPtr self, AppId nConsumerAppId, WorkshopFileType eFileType);
...
#region FunctionMeta
    ...
    static extern UGCUpdateHandle_t _StartItemUpdate(IntPtr self, AppId nConsumerAppId, PublishedFileId nPublishedFileID);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetItemVisibility(IntPtr self, UGCUpdateHandle_t handle, RemoteStoragePublishedFileVisibility eVisibility);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetItemTags(IntPtr self, UGCUpdateHandle_t updateHandle, ref SteamParamStringArray_t pTags);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _SetAllowLegacyUpload(IntPtr self, UGCUpdateHandle_t handle, [MarshalAs(UnmanagedType.U1)] bool bAllowLegacyUpload);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _RemoveAllItemKeyValueTags(IntPtr self, UGCUpdateHandle_t handle);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _RemoveItemPreview(IntPtr self, UGCUpdateHandle_t handle, uint index);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _SubmitItemUpdate(IntPtr self, UGCUpdateHandle_t handle, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchChangeNote);
...
#region FunctionMeta
    ...
    static extern ItemUpdateStatus _GetItemUpdateProgress(IntPtr self, UGCUpdateHandle_t handle, ref ulong punBytesProcessed, ref ulong punBytesTotal);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _SetUserItemVote(IntPtr self, PublishedFileId nPublishedFileID, [MarshalAs(UnmanagedType.U1)] bool bVoteUp);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _GetUserItemVote(IntPtr self, PublishedFileId nPublishedFileID);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _AddItemToFavorites(IntPtr self, AppId nAppId, PublishedFileId nPublishedFileID);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _RemoveItemFromFavorites(IntPtr self, AppId nAppId, PublishedFileId nPublishedFileID);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _SubscribeItem(IntPtr self, PublishedFileId nPublishedFileID);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _UnsubscribeItem(IntPtr self, PublishedFileId nPublishedFileID);
...
#region FunctionMeta
    ...
    static extern uint _GetNumSubscribedItems(IntPtr self);
...
#region FunctionMeta
    ...
    static extern uint _GetSubscribedItems(IntPtr self, [In] [Out] PublishedFileId[] pvecPublishedFileID, uint cMaxEntries);
...
#region FunctionMeta
    ...
    static extern uint _GetItemState(IntPtr self, PublishedFileId nPublishedFileID);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetItemInstallInfo(IntPtr self, PublishedFileId nPublishedFileID, ref ulong punSizeOnDisk, IntPtr pchFolder, uint cchFolderSize, ref uint punTimeStamp);
    ...
    internal bool GetItemInstallInfo(PublishedFileId nPublishedFileID, ref ulong punSizeOnDisk, out string pchFolder, ref uint punTimeStamp) {
        var mempchFolder = Helpers.TakeMemory();
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _GetItemDownloadInfo(IntPtr self, PublishedFileId nPublishedFileID, ref ulong punBytesDownloaded, ref ulong punBytesTotal);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _DownloadItem(IntPtr self, PublishedFileId nPublishedFileID, [MarshalAs(UnmanagedType.U1)] bool bHighPriority);
...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _BInitWorkshopForGameServer(IntPtr self, DepotId_t unWorkshopDepotID, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pszFolder);
...
#region FunctionMeta
    ...
    static extern void _SuspendDownloads(IntPtr self, [MarshalAs(UnmanagedType.U1)] bool bSuspend);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _StartPlaytimeTracking(IntPtr self, [In] [Out] PublishedFileId[] pvecPublishedFileID, uint unNumPublishedFileIDs);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _StopPlaytimeTracking(IntPtr self, [In] [Out] PublishedFileId[] pvecPublishedFileID, uint unNumPublishedFileIDs);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _StopPlaytimeTrackingForAllItems(IntPtr self);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _AddDependency(IntPtr self, PublishedFileId nParentPublishedFileID, PublishedFileId nChildPublishedFileID);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _RemoveDependency(IntPtr self, PublishedFileId nParentPublishedFileID, PublishedFileId nChildPublishedFileID);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _AddAppDependency(IntPtr self, PublishedFileId nPublishedFileID, AppId nAppID);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _RemoveAppDependency(IntPtr self, PublishedFileId nPublishedFileID, AppId nAppID);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _GetAppDependencies(IntPtr self, PublishedFileId nPublishedFileID);
...
#region FunctionMeta
    ...
    static extern SteamAPICall_t _DeleteItem(IntPtr self, PublishedFileId nPublishedFileID);
