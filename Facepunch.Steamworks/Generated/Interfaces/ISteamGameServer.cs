...
#region FunctionMeta
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    static extern bool _BUpdateUserData(IntPtr self, SteamId steamIDUser, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringToNative))] string pchPlayerName, uint uScore);
