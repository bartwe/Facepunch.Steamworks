...
namespace Steamworks.Data
{
	...
	internal partial struct gameserveritem_t
	{
		...
		[MarshalAs( UnmanagedType.I1 )] internal bool HadSuccessfulResponse; // m_bHadSuccessfulResponse bool
		[MarshalAs( UnmanagedType.I1 )] internal bool DoNotRefresh; // m_bDoNotRefresh bool

		internal string GameDirUTF8() =>
			System.Text.Encoding.UTF8.GetString( GameDir, 0, System.Array.IndexOf<byte>( GameDir, 0 ) );
		...
		internal string MapUTF8() =>
			System.Text.Encoding.UTF8.GetString( Map, 0, System.Array.IndexOf<byte>( Map, 0 ) );

		[MarshalAs( UnmanagedType.ByValArray, SizeConst = 32 )] // byte[] m_szMap
		internal byte[] Map; // m_szMap char [32]

		internal string GameDescriptionUTF8() => System.Text.Encoding.UTF8.GetString( GameDescription, 0,
			System.Array.IndexOf<byte>( GameDescription, 0 ) );
		...
		[MarshalAs( UnmanagedType.I1 )] internal bool Password; // m_bPassword bool
		[MarshalAs( UnmanagedType.I1 )] internal bool Secure; // m_bSecure bool
		...
		internal string ServerNameUTF8() =>
			System.Text.Encoding.UTF8.GetString( ServerName, 0, System.Array.IndexOf<byte>( ServerName, 0 ) );
		...
		internal string GameTagsUTF8() =>
			System.Text.Encoding.UTF8.GetString( GameTags, 0, System.Array.IndexOf<byte>( GameTags, 0 ) );
	...
	internal partial struct SteamDatagramHostedAddress
	{
		...
		internal string DataUTF8() =>
			System.Text.Encoding.UTF8.GetString( Data, 0, System.Array.IndexOf<byte>( Data, 0 ) );
	...
	internal struct SteamDatagramGameCoordinatorServerLogin
	{
		...
		internal string AppDataUTF8() =>
			System.Text.Encoding.UTF8.GetString( AppData, 0, System.Array.IndexOf<byte>( AppData, 0 ) );
